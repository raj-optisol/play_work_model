...
module Orders
  describe SummaryCell do

    context "cell instance" do
      subject { cell("orders/summary") }
    ...
    context "cell rendering" do
      ...
      context "rendering show" do
        subject { render_cell("orders/summary", :show, order: order) }

        it { should have_selector("span", :text => "TOTAL") }

        it { should have_selector("span", :text => "{{order.item_count}}") }
        it { should have_selector("span", :text => '{{order.amount | currency:"$"}}') }
