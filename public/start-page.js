...
function initSmoothScroll(){
    ...
    $('.scroll-link').filter('[href^="#"]').on('click', function(e){
        e.preventDefault();
        var linksAttr = jQuery(this).attr('href');
        var targetPos = jQuery(linksAttr).offset().top;

        jQuery('html,body').stop().animate({scrollTop: targetPos}, 500);
    });
}
